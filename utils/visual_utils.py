# Based on ideas from: https://gitlab.com/UnBVision/edgenet360/-/blob/master/lib_edgenet360/file_utils.py?ref_type=heads
...
class_names = ["empty", "ceiling", "floor", "wall", "window", "chair", "bed", "sofa",
               "table", "tvs", "furniture", "objects"]


def write_header(obj_file, mtl_file, name):
    obj_file.write("# MDBNet360 Wavefront obj exporter v1.0\n")
